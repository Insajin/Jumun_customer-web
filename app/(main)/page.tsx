...
export default function HomePage() {
  ...
  useEffect(() => {
    async function fetchBrand() {
      try {
        // In a real app, you'd get brand_id from domain/subdomain or config
        // For now, we'll get the first brand
      ...
      <div className="bg-white border-b sticky top-0 z-10">
        <div className="max-w-2xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-xl font-bold">{brand?.name || 'Jumun'}</h1>
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-8">
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            <a href="/stores" className="text-sm text-blue-600 hover:text-blue-700">
              더보기 →
            </a>
          </div>
          <RecommendedMenus />
